...
<tr>
              ...
              <td>@if($membercheckout['name_on_card']!=''){{$membercheckout['name_on_card']}} @else <b style="color:red;"> Not Found </b> @endif</td>
              ...
              <td>@if($membercheckout['auth_id']!=''){{$membercheckout['auth_id']}} @else <b style="color:red;"> Not Found </b>  @endif</td>
