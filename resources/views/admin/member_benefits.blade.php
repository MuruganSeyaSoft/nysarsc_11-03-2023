...
@section('content')
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Member Benefits / Fees Management</span>
        </nav>
      </div><!-- br-pageheader -->
      ...
      <div class="br-pagebody">
        ...
        <a href="javascript:;" class="btn btn-primary btn-with-icon pull-right mb-1 add-button">
            <div class="ht-40">
                ...
                <span class="pd-x-15">Add New Member Benefits / Fees Details Section</span>
            </div>
        </a>
              ...
              <!-- <td>{{$a}}</td> -->
               ...
               <a class="btn btn-outline-primary btn-sm edit-button"  onclick="return show_modal{{$title['id']}}(this);">
                        ...
                        <a  onclick="return confirm('Are you sure to delete?')" 
                                href="{{route('bene_member_delete',$title['id'])}}"><b style="color:red;"><i class="icon ion-trash-b"></i></b></a>
               </td>
               <td>
                  @if($title['status']==1)
                  ...
                  <br><br>
                  @if($title['status']==1)
                  <a href="{{route('bene_member_status_deactive',$title['id'])}}" title="Deactivate"> <i class="icon ion-arrow-down-b"></i></a>
                  @else
                  <a href="{{route('bene_member_status_active',$title['id'])}}"  title="Activate"> <i class="icon ion-arrow-up-c"></i></a>
                  @endif
                 </td>
...
<script>
        ...
        <div class="modal-dialog">
          <div class="modal-content" style="height:100%;overflow:auto;">
            ...
            <form class="" id="" action="{{route('bene_member_update')}}" method="POST" enctype="multipart/form-data">
                @csrf
               ...
               <div class="modal-body">
                    ...
                    <textarea   name="bene_member" id="description"
...
@section('scripts')
    ...
    <script>
        ...
        messages: {
            bene_member: {
                required: "Member Benefits / Fees Details is required"
            },
