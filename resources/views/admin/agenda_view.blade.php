      ...
      <div class="br-pagebody">
        ...
        <form class="form-user" id="form-user" action="javascript:;">
          ...
          <textarea   name="agenda" id="description"
                class="summernote1"  rows="5" placeholder="Description"  > {{$details['agenda']}}</textarea>
...
<script>
        ...
        $('#site_title').html(' | Conference Section Management ')
    </script>
@else
<script>
        $('#webinar').addClass('active')
        $('#site_title').html(' | Webinar Section Management ')
    </script>
@endif
