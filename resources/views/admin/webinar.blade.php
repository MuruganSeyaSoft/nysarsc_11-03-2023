...
@section('content')
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active"> Webinar  Management</span>
        </nav>
      </div><!-- br-pageheader -->
      ...
      <div class="br-pagebody">
        ...
        <a href="javascript:;" class="btn btn-primary btn-with-icon pull-right mb-1 add-button">
            <div class="ht-40">
                ...
                <span class="pd-x-15">Add New Webinar Section</span>
            </div>
        </a>
                 ...
                 <td >
                  ...
                  @if($title['status']==1)
                            <td>
                              ...
                              @else  
                                <a href="{{route('agenda',$title['id'])}}" > Add New</a><br><br>
                              @endif
                              </td>
                    @else
        ...
        <div class="modal-dialog">
          <div class="modal-content" style="height:100%;overflow:auto;">
            <div class="modal-header">
              <h4 class="modal-title text-center" id="myModalLabel">Edit  Title Details</h4>
            </div>
      ...
      <footer class="br-footer">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title text-center" id="myModalLabel">Add New Webinar Section</h4>
            </div>
            ...
            <form class="form-user" id="form-user" action="javascript:;">
              <div class="modal-body">
                  <input type="hidden" name="type" value="2">
                    ...
                    <div class="form-group">
                    <label>New Webinar Section  <span class="tx-danger">*</span></label>
                    <input class="form-control" id="new_c_title"  type="text"  required   name="new_c_title"  >
                    </div>
...
@section('scripts')
    <script>
        ...
        $('#site_title').html(' | Webinar Details Management ')
    </script>
    ...
    <script>
        ...
        messages: {
          new_c_title: {
                required: "Webinar Section Title Details is required"
            },
