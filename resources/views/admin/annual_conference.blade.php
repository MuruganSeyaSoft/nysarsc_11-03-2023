...
@section('content')
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">{{$name_title}}  Management</span>
        </nav>
      </div><!-- br-pageheader -->
      ...
      <div class="br-pagebody">
        ...
        <a href="javascript:;" class="btn btn-primary btn-with-icon pull-right mb-1 add-button">
            <div class="ht-40">
                ...
                <span class="pd-x-15">Add New Sub Menu</span>
            </div>
        </a>
                  ...
                  <!-- @if($title['status']==1)
                            <td>
                              @if($title['speaker']!='')
                                ...
                                <a href="{{route('speaker_view',$title['id'])}}" target="_blank">Update</a><br><br>
                                
                                <a  onclick="return confirm('Are you sure?')" 
                                href="{{route('speaker_delete',$title['id'])}}"><b style="color:red;">Delete</b></a>
                              @else  
                                <a href="{{route('speaker',$title['id'])}}" target="_blank"> Add New</a><br><br>
                              @endif
                              </td>
                    @else
        ...
        <div class="modal-dialog">
          <div class="modal-content" style="height:100%;overflow:auto;">
            <div class="modal-header">
              <h4 class="modal-title text-center" id="myModalLabel">Edit  Sub Menu Details</h4>
            </div>
            <form class="" id="" action="{{route('annual_conference_second_update')}}" method="POST" enctype="multipart/form-data">
                @csrf
               ...
               <div class="modal-body">
                    ...
                    <input class="form-control" id="title"  type="text"  name="sub_menu" value="{{$title['title']}}" >
                    </div>
                    </div>
                    </div>
      ...
      <footer class="br-footer">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title text-center" id="myModalLabel">Add New Sub Menu</h4>
            </div>
            ...
            <form class="form-user" id="form-user" action="javascript:;">
              ...
              <input type="hidden" name="annual_id" value="{{$annual_id}}">
                    <div class="row">
                    <div class="col-md-12">

                  
                    <div class="form-group">
                    <label>Sub Menu Title  <span class="tx-danger">*</span></label>
                    <input class="form-control" id="new_c_title"  type="text"    name="sub_menu"  >
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        messages: {
          sub_menu: {
                required: "Sub Menu Titles  is required"
            }
        },
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "post",
                url: "{{route('conference_store_second')}}",
                data: data,
                dataType: "json",
                processData: false,
                contentType: false,
