...
@section('content')
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Speaker Page Details</span>
...
@if($errors->any())
      ...
      <div class="br-pagebody">
        ...
        <form class="form-user" id="form-user" action="javascript:;">
          ...
          <textarea   name="speaker" id="description"
                class="summernote1"  rows="5" placeholder="Description"  > {{$details['speaker']}}</textarea>
...
@section('scripts')
    <script>
        ...
        $('#site_title').html(' | Speaker Page Management ')
    </script>
    ...
    <script>
        ...
        messages: {
            speaker: {
                required: "Speaker Message is Required"
            },
