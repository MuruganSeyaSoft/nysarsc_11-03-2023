...
<tr>
              <td>{{$a}}</td>
               ...
               <td> 
               <a class="btn btn-outline-primary btn-sm edit-button"  onclick="return show_modal{{$admin['id']}}(this);">
...
<script>
                function show_modal{{$admin['id']}}(e)
                {
                    console.log (e.href);
                    $("#iframe_modal").attr("src", e.href);
                    $('#myModal{{$admin['id']}}').modal('show');
                    return false;
                }
                </script>
                   ...
                   <!-- Edit Modal -->
        <div class="modal fade" id="myModal{{$admin['id']}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="overflow:hidden;">
        <div class="modal-dialog">
          <div class="modal-content" style="height:100%;overflow:auto;">
            <div class="modal-header">
              <h4 class="modal-title text-center" id="myModalLabel">Edit  Price Details</h4>
            </div>
                 <form class="form-user" id="form-user" action="javascript:;">
                
                <input type="hidden" name="c_id" value="{{$admin['id']}}">
               <div class="modal-body">
                    ...
                    <input class="form-control" id="couponcode"  type="text"  name="price" value="{{$admin['price']}}" >
                  </div>
                    </div>
...
@section('scripts')
    <script>
        $('#price_update').addClass('active')
        $('#site_title').html(' | Price Management ')
    </script>
