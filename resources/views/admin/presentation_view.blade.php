...
@section('content')
      <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Presentation Page Details</span>
...
@if($errors->any())
      ...
      <div class="br-pagebody">
        ...
        <form class="form-user" id="form-user" action="javascript:;">
          ...
          <input type="hidden" name="annual_title_id" value="{{$details['id']}}">
          
         
          <div class="table-wrapperb" >
          <textarea   name="presentation" id="description"
                class="summernote1"  rows="5" placeholder="Description"  > {{$details['downloadsoption']}}</textarea>
            ...
            <br>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default" onclick='window.location.href= "{{URL::to('annual_conference')}}" '>Main Menu</button>
                <button type="submit" class="btn btn-primary button-save addBtn">Update Details</button>
              </div>
</form>
...
<a  onclick="return confirm('Are you sure want Delete Records ?')" 
 href="{{route('presentation_pdf_delete',$pageDetails['id'])}}"><b style="color:red;">Delete</b></a>&nbsp; &nbsp;-- &nbsp;&nbsp;
 <a href="{{ url('presentation/'.$pageDetails['data']) }}" download><b>Download</b></a> -- 
  {{$pageDetails['data']}}
<br><hr>
@endforeach
...
@section('scripts')
    <script>
        ...
        $('#site_title').html(' | Presentation Page Management ')
    </script>
    ...
    <script>
        ...
        messages: {
            presentation: {
                required: "Presentation Message is Required"
            },
