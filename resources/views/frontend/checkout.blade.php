...
<!-- Stylesheets -->
<link href="{{asset('frontend_lib-delete/css/bootstrap.css')}}" rel="stylesheet">
<link href="{{asset('frontend_lib-delete/css/style.css')}}" rel="stylesheet">
<link href="{{asset('frontend_lib-delete/css/responsive.css')}}" rel="stylesheet">
<!--Color Switcher Mockup-->
<link href="{{asset('frontend_lib-delete/css/color-switcher-design.css')}}" rel="stylesheet">

<link rel="shortcut icon" href="{{asset('frontend_lib-delete/images/favicon.png')}}" type="image/x-icon">
<link rel="icon" href="{{asset('frontend_lib-delete/images/favicon.png')}}" type="image/x-icon">
    ...
    <header class="main-header">
        <div class="main-box">
        	<div class="auto-container clearfix">
            	<div class="logo-box">
                	<div class="logo"><a href="{{route('landing')}}"><img src="{{asset('frontend_lib-delete/images/nysarsc-logo.jpeg')}}" alt="" title=""></a></div>
                </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="{{asset('frontend_lib-delete/images/nysarsc-logo.jpeg')}}" alt="" title=""></a></div>
...
<h4>Type Of Registration : <b style="color:red;">
@if($page_type ==1) 
Event / Conference Registration   <br/>
@elseif($page_type == 2)
Membership Card  
@else
Webinar Section
...
<h4>Amount : <b style="color:red;">
@if($page_type ==1) 
<p style="color:red;">Before  April 29 th $ 250.00 Registration</p> 
<p style="color:red;">After April 30 th , 2023 $ 275.00 Registration</p>
@elseif($page_type == 2)
<p style="color:red;">$ 5.00</p>   
@else
<p style="color:red;">$ 250.00</p>
@endif
</b></h4><br>
    ...
    <br/>
                    ...
                    <div class="panel panel-info"  id='business'>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-12"><strong>Paid Service For   &nbsp;&nbsp;:&nbsp; &nbsp;<b style="color:red;"> 
                                    @if($page_type ==1) 
                            ...
                            <div class="form-group">
                                <div class="col-md-12"><strong>Reference Person Added  &nbsp;&nbsp;:&nbsp; &nbsp;<b style="color:red;"> {{$mem_count}} </b></strong>
                            <a href="{{route('current_users')}}" title="Referenced Users List" ><b style="color:blue;"> (  View  ) </b>  </a></div>
                                <div class="col-md-12"></div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12"><strong>Amount (<b style="color:red;">  $ </b>)</strong></div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <div class="col-md-6 col-xs-6">
                                    ...
                                    <input type="text" id="country" placeholder="" name="country" class="form-control" value="USA" readonly />
                                </div>
                                 <div class="col-md-6 col-xs-6">
                            ...
                            <label>
				        <input type="checkbox" name="colorCheckbox" value="C" checked> Create Account on this Member ? </label>
                 
                            <div class="C selectt">
                                <div class="col-md-6 col-xs-6">
                                    <strong>Username :</strong>
                                    <input type="text" id="username" placeholder="" name="username" class="form-control" value="" />
                                </div>
                                 <div class="col-md-6 col-xs-6">
                                    <strong>Password</strong>
                                      <input type="text" id="password" placeholder="" name="password" class="form-control" value="" />
                                </div>
                    ...
                    $(document).ready(function() {
                        $('input[type="checkbox"]').click(function() {
                            ...
                            <div class="col-md-12"><strong></strong></div>
                                <div class="col-md-12">
                                @if($page_type ==2) 
                                <button class="btn btn-success" disabled>Register Another Person</button>
                                @else
...
<script src="{{asset('frontend_lib-delete/js/jquery.js')}}"></script>
<script src="{{asset('frontend_lib-delete/js/popper.min.js')}}"></script>
<script src="{{asset('frontend_lib-delete/js/bootstrap.min.js')}}"></script>
<script src="{{asset('frontend_lib-delete/js/jquery-ui.js')}}"></script>
<script src="{{asset('frontend_lib-delete/js/jquery.fancybox.js')}}"></script>
<script src="{{asset('frontend_lib-delete/js/appear.js')}}"></script>
<script src="{{asset('frontend_lib-delete/js/owl.js')}}"></script>
<script src="{{asset('frontend_lib-delete/js/wow.js')}}"></script>
<script src="{{asset('frontend_lib-delete/js/script.js')}}"></script>
<!-- Color Setting -->
